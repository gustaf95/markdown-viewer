...
import type { AppCommand, EncodingChoice, ExportRequest, ExportResult, FileErrorPayload, FileOpenedPayload, ImportFormat, ImportResult, MdvApi, PrintResult, SaveResult } from '../common/types';
...
const api: MdvApi = {
  ...
  exportDocument: (request: ExportRequest): Promise<ExportResult> => ipcRenderer.invoke('file:export', request),
  importDocument: (format: ImportFormat): Promise<ImportResult> => ipcRenderer.invoke('file:import', format),
